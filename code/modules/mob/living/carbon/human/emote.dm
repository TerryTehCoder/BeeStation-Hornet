...
/datum/emote/living/carbon/human/scream/get_sound(mob/living/user)
	...
	//DONKSTATION CHANGE START: added more screams to races
	else if(isipc(H))
		return pick('sound/voice/ipc/robot_scream.ogg','sound/voice/ipc/robot_scream_2.ogg')
	else if (isteshari(H)) //DONKSTATION CHANGE: ADDED TESHARI
		return 'sound/voice/teshari/teshari_scream.ogg'
	else if (isskeleton(H) || isplasmaman(H))
		return 'sound/voice/skeleton/skeleton_scream.ogg'
	else if (isflyperson(H) || isapid(H))
		return 'sound/voice/fly/fly_scream.ogg'
	else if (ispodperson(H) || isabductor(H))
		return 'sound/voice/abductor/allen_scream.ogg'
	else if (isoozeling(H) || isslimeperson(H) || isjellyperson(H))
		return 'sound/voice/ooze/ooze_scream.ogg'
	else if (isethereal(H))
		return 'sound/voice/ethereal/ethereal_scream.ogg'
	else if (issquidperson(H))
		return 'sound/voice/squid/squid_scream.ogg'
...
/datum/emote/living/carbon/human/fart/get_sound(mob/living/user)
	if(!ishuman(user))
		return
	//DONKSTATION CHANGE START: added IPC farts
	if(isipc(user))
		return 'sound/misc/poo2_robot.ogg'
	else
		return pick('sound/misc/fart1.ogg','sound/misc/fart2.ogg','sound/misc/fart3.ogg','sound/misc/fart4.ogg')
	//DONKSTATION CHANGE END
