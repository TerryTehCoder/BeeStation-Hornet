...
/mob/living/silicon/ai
	...
	//DONKSTATION CHANGES START: Cyborg Pathing Variables
...
/mob/living/silicon/ai/Initialize(mapload, datum/ai_laws/L, mob/target_ai)
	...
	if(isturf(loc))
		...
		/mob/living/silicon/ai/proc/set_automatic_say_channel, /mob/living/silicon/ai/proc/borgmanagement)) //DONKSTATION CHANGE: added borgmanagement
...
/mob/living/silicon/ai/Topic(href, href_list)
	...
	if(href_list["botrefresh"]) //Refreshes the bot control panel.
		botcall()
		return
	//DONKSTATION CHANGE START: Silicon Management
